...
<?php // TODO:falta filtrar um novo comentário direto nesta página ?>
<div class="comments">
...
<?php else: ?>
		...
		<?php else: ?>
			...
			<?php $comments_args = array(
			 	'title_reply'       => __( 'Enviar um novo comentário' ),
		...
		<?php if ( have_comments() ) : ?>
			...
			<h2 class="comments-title">
				...
				<?php echo count($wp_query->comments_by_type['general-comment']) . ' ';
				echo _n( 'Comentário' , 'Comentários' , count($wp_query->comments_by_type['general-comment']), 'hemingway' ); ?>

			</h2>

			<ol class="commentlist">
			    <?php wp_list_comments( array( 'type' => 'general-comment', 'callback' => 'cdbr_pna_comment' ) ); ?>
			</ol>
